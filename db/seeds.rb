...
pb1 = ProviderBio.create(provider_id: p1.id, location: Faker::Address.state, certified_nurse_aide: true, registered_nurse: false, year_in_healthcare: rand(3..25), personal_care: true, nursing_care: false, rate: rand(29.0..79.0), description: "I really enjoy providing support to families with their loved ones!" )
pb2 = ProviderBio.create(provider_id: p2.id, location: Faker::Address.state, certified_nurse_aide: true, registered_nurse: false, year_in_healthcare: rand(3..25), personal_care: true, nursing_care: false, rate: rand(29.0..79.0), description: "I really enjoy providing support to families with their loved ones!" )
pb3 = ProviderBio.create(provider_id: p3.id, location: Faker::Address.state, certified_nurse_aide: true, registered_nurse: false, year_in_healthcare: rand(3..25), personal_care: true, nursing_care: false, rate: rand(29.0..79.0), description: "I really enjoy providing support to families with their loved ones!" )
pb4 = ProviderBio.create(provider_id: p4.id, location: Faker::Address.state, certified_nurse_aide: true, registered_nurse: false, year_in_healthcare: rand(3..25), personal_care: true, nursing_care: false, rate: rand(29.0..79.0), description: "I really enjoy providing support to families with their loved ones!" )
pb5 = ProviderBio.create(provider_id: p5.id, location: Faker::Address.state, certified_nurse_aide: true, registered_nurse: false, year_in_healthcare: rand(3..25), personal_care: true, nursing_care: false, rate: rand(29.0..79.0), description: "I really enjoy providing support to families with their loved ones!" )
pb6 = ProviderBio.create(provider_id: p6.id, location: Faker::Address.state, certified_nurse_aide: true, registered_nurse: false, year_in_healthcare: rand(3..25), personal_care: true, nursing_care: false, rate: rand(29.0..79.0), description: "I really enjoy providing support to families with their loved ones!" )
pb7 = ProviderBio.create(provider_id: p7.id, location: Faker::Address.state, certified_nurse_aide: true, registered_nurse: false, year_in_healthcare: rand(3..25), personal_care: true, nursing_care: false, rate: rand(29.0..79.0), description: "I really enjoy providing support to families with their loved ones!" )
