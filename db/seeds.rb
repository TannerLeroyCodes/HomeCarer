...
ub2 = UserBio.create(user_id: u3.id, location: Faker::Address.state, description: "Looking for an in-home care-giver ", patient_age: rand(50..95), patient_description: "The patient suffers from chromic joint pain. Looking for someone to keep on eye on the patient and assist with necessary as they are not very mobile." )
