...
pb1 = ProviderBio.create(provider_id: p1.id, location: ub1.location, certified_nurse_aide: true, registered_nurse: false, year_in_healthcare: rand(3..25), personal_care: true, nursing_care: false, rate: rand(29..79), description: "I really enjoy providing support to families with their loved ones!" )
...
pb5 = ProviderBio.create(provider_id: p5.id, location: Faker::Address.state, certified_nurse_aide: true, registered_nurse: false, year_in_healthcare: rand(3..25), personal_care: true, nursing_care: false, rate: rand(29..79), description: "I really enjoy providing support to families with their loved ones!" )
