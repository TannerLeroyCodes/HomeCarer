...
pb1 = ProviderBio.create(provider_id: p1.id, location: Faker::Address.state, certified_nurse_aide: true, registered_nurse: false, year_in_healthcare: rand(3..25), personal_care: true, nursing_care: false, rate: rand(29.0..79.0).round(2), description: "I really enjoy providing support to families with their loved ones!" )
pb2 = ProviderBio.create(provider_id: p2.id, location: Faker::Address.state, certified_nurse_aide: true, registered_nurse: false, year_in_healthcare: rand(3..25), personal_care: true, nursing_care: false, rate: rand(29.0..79.0).round(2), description: "I really enjoy providing support to families with their loved ones!" )
pb3 = ProviderBio.create(provider_id: p3.id, location: Faker::Address.state, certified_nurse_aide: true, registered_nurse: false, year_in_healthcare: rand(3..25), personal_care: true, nursing_care: false, rate: rand(29.0..79.0).round(2), description: "I really enjoy providing support to families with their loved ones!" )
pb4 = ProviderBio.create(provider_id: p4.id, location: Faker::Address.state, certified_nurse_aide: true, registered_nurse: false, year_in_healthcare: rand(3..25), personal_care: true, nursing_care: false, rate: rand(29.0..79.0).round(2), description: "I really enjoy providing support to families with their loved ones!" )
pb5 = ProviderBio.create(provider_id: p5.id, location: Faker::Address.state, certified_nurse_aide: true, registered_nurse: false, year_in_healthcare: rand(3..25), personal_care: true, nursing_care: false, rate: rand(29.0..79.0).round(2), description: "I really enjoy providing support to families with their loved ones!" )
pb6 = ProviderBio.create(provider_id: p6.id, location: Faker::Address.state, certified_nurse_aide: true, registered_nurse: false, year_in_healthcare: rand(3..25), personal_care: true, nursing_care: false, rate: rand(29.0..79.0).round(2), description: "I really enjoy providing support to families with their loved ones!" )
pb7 = ProviderBio.create(provider_id: p7.id, location: Faker::Address.state, certified_nurse_aide: true, registered_nurse: false, year_in_healthcare: rand(3..25), personal_care: true, nursing_care: false, rate: rand(29.0..79.0).round(2), description: "I really enjoy providing support to families with their loved ones!" )


puts "Starting to seed Appointments..."

Appointment.create(user_id: tanner.id, provider_id: p1.id, date:Faker::Date.in_date_period, accepted: false, declined: false, type_of_care: "Personal care", notes: "Please heatup dinner and keep on eye on Ed. Feel free to put on any movie he is easy-going", length_in_hours: rand(1..6))
Appointment.create(user_id: tanner.id, provider_id: p3.id, date:Faker::Date.in_date_period, accepted: false, declined: false, type_of_care: "Personal care", notes: "Please heatup dinner and keep on eye on Ed. Feel free to put on any movie he is easy-going", length_in_hours: rand(1..6))
Appointment.create(user_id: tanner.id, provider_id: p4.id, date:Faker::Date.in_date_period, accepted: false, declined: false, type_of_care: "Personal care", notes: "Please heatup dinner and keep on eye on Ed. Feel free to put on any movie he is easy-going", length_in_hours: rand(1..6))
Appointment.create(user_id: tanner.id, provider_id: p1.id, date:Faker::Date.in_date_period, accepted: false, declined: false, type_of_care: "Personal care", notes: "Please heatup dinner and keep on eye on Ed. Feel free to put on any movie he is easy-going", length_in_hours: rand(1..6))
Appointment.create(user_id: tanner.id, provider_id: p5.id, date:Faker::Date.in_date_period, accepted: false, declined: false, type_of_care: "Personal care", notes: "Please heatup dinner and keep on eye on Ed. Feel free to put on any movie he is easy-going", length_in_hours: rand(1..6))
